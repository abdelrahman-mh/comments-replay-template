const GitHub = () => {
  return (
    <a target='_blank' rel='noopener noreferrer' href='https://github.com/abdelrahman-mh/comments-replay-template' className='github-corner' aria-label='View source on GitHub'>
